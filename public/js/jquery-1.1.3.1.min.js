if (typeof window.jQuery == "undefined") {
    ...
    jQuery.fn = jQuery.prototype = {
        init: function (a, c) {
            ...
            if (typeof a == "string") {
                var m = /^[^<]*(<(.|\s)+>)[^>]*$/.exec(a);
                if (m) a = jQuery.clean([m[1]]); else return new jQuery(c).find(a)
            }
            ...
            var f = c;
            if (c.constructor == String) if (d == undefined) return this.length && jQuery[e || "attr"](this[0], c) || undefined; else {
                f = {};
                f[c] = d
            }
            return this.each(function (a) {
                for (var b in f) jQuery.attr(e ? this.style : this, b, jQuery.prop(this, f[b], e, a, b))
            })
        }, css: function (a, b) {
            ...
            e.each(function () {
                var a = this._$events;
                for (var b in a) for (var c in a[b]) jQuery.event.add(this, b, a[b][c], a[b][c].data);
                this._$events = null
            });
            return r
        }, filter: function (t) {
    ...
    jQuery.extend = jQuery.fn.extend = function () {
        ...
        var c;
        while ((c = arguments[a++]) != null) for (var i in c) b[i] = c[i];
        return b
    };
    jQuery.extend({
        noConflict: function () {
            ...
            if (a.length == undefined) for (var i in a) b.apply(a[i], c || [i, a[i]]); else for (var i = 0, ol = a.length; i < ol; i++) if (b.apply(a[i], c || [i, a[i]]) === false) break;
            return a
        }, prop: function (a, b, c, d, e) {
            if (jQuery.isFunction(b)) b = b.call(a, [d]);
            ...
            if (b.match(/float/i)) b = jQuery.styleFloat;
            if (!d && a.style[b]) e = a.style[b]; else if (document.defaultView && document.defaultView.getComputedStyle) {
                if (b.match(/float/i)) b = "float";
                b = b.replace(/([A-Z])/g, "-$1").toLowerCase();
                var f = document.defaultView.getComputedStyle(a, null);
                if (f) e = f.getPropertyValue(b); else if (b == "display") e = "none"; else jQuery.swap(a, {display: "block"}, function () {
            ...
            jQuery.each(a, function (i, a) {
                ...
                if (typeof a == "string") {
                    ...
                    while (b[0]--) div = div.firstChild;
                    if (jQuery.browser.msie) {
                        if (!s.indexOf("<table") && s.indexOf("<tbody") < 0) tb = div.firstChild && div.firstChild.childNodes; else if (b[1] == "<table>" && s.indexOf("<tbody") < 0) tb = div.childNodes;
                ...
                if (0 === a.length && (!jQuery.nodeName(a, "form") && !jQuery.nodeName(a, "select"))) return;
                if (a[0] == undefined || jQuery.nodeName(a, "form") || a.options) r.push(a); else r = jQuery.merge(r, a)
            });
            return r
        }, attr: function (a, c, d) {
            ...
            if (e[c]) {
                ...
                return a[e[c]]
            } else if (d == undefined && jQuery.browser.msie && jQuery.nodeName(a, "form") && (c == "action" || c == "method")) return a.getAttributeNode(c).nodeValue; else if (a.tagName) {
                if (d != undefined) a.setAttribute(c, d);
                if (jQuery.browser.msie && /href|src/.test(c) && !jQuery.isXMLDoc(a)) return a.getAttribute(c, 2);
            ...
            var r = [];
            if (typeof a != "array") for (var i = 0, al = a.length; i < al; i++) r.push(a[i]); else r = a.slice(0);
            return r
    ...
    jQuery.extend({
            ...
            while (t && last != t) {
                ...
                if (m) {
                    ...
                    if ((m = e.exec(t)) != null) {
                        ...
                        m = m[1];
                        for (var j = 0, rl = b.length; j < rl; j++) if (m.indexOf("..") < 0) {
                ...
                if (t && !d) {
                    if (!t.indexOf(",")) {
                        ...
                        if (m[1] == "#" && h && h.getElementById) {
                            ...
                            if ((jQuery.browser.msie || jQuery.browser.opera) && k && typeof k.id == "string" && k.id != m[2]) k = jQuery('[@id="' + m[2] + '"]', h)[0];
        ...
        filter: function (t, r, b) {
            ...
            while (t && t != d) {
                ...
                if (!m) break;
                if (m[1] == ":" && m[2] == "not") r = jQuery.filter(m[3], r, true).r; else if (m[1] == ".") r = jQuery.classFilter(r, m[2], b); else if (m[1] == "@") {
                    var e = [], type = m[3];
    ...
    jQuery.event = {
        add: function (b, c, d, e) {
            ...
            if (jQuery.inArray(b, this.global[c]) == -1) this.global[c].push(b)
        }, guid: 1, global: {}, remove: function (a, b, c) {
            ...
            if (d) {
                ...
                if (!b) {
                    ...
                    if (c) delete d[b][c.guid]; else for (c in a.$events[b]) delete d[b][c];
                    for (ret in d[b]) break;
                    if (!ret) {
                        if (a.removeEventListener) a.removeEventListener(b, a.$handle, false); else a.detachEvent("on" + b, a.$handle);
                        ret = null;
                        delete d[b];
                        while (this.global[b] && ((index = jQuery.inArray(a, this.global[b])) >= 0)) delete this.global[b][index]
                    }
                }
                for (ret in d) break;
                if (!ret) a.$handle = a.$events = null
            }
        }, trigger: function (a, b, c) {
            b = jQuery.makeArray(b || []);
            if (!c) jQuery.each(this.global[a] || [], function () {
                jQuery.event.trigger(a, b, this)
            }); else {
                var d, ret, fn = jQuery.isFunction(c[a] || null);
                b.unshift(this.fix({type: a, target: c}));
                if (jQuery.isFunction(c.$handle) && (d = c.$handle.apply(c, b)) !== false) this.triggered = true;
                if (fn && d !== false && !jQuery.nodeName(c, 'a')) c[a]();
            ...
            if (jQuery.browser.msie) a.target = a.preventDefault = a.stopPropagation = a.handler = a.data = null;
            return b
        }, fix: function (a) {
            var c = a;
            a = jQuery.extend({}, c);
            a.preventDefault = function () {
                if (c.preventDefault) return c.preventDefault();
                c.returnValue = false
            };
            a.stopPropagation = function () {
                if (c.stopPropagation) return c.stopPropagation();
                c.cancelBubble = true
            };
            if (!a.target && a.srcElement) a.target = a.srcElement;
            if (jQuery.browser.safari && a.target.nodeType == 3) a.target = c.target.parentNode;
    ...
    jQuery.fn.extend({
        bind: function (a, b, c) {
            ...
            if (jQuery.isReady) f.apply(document, [jQuery]); else jQuery.readyList.push(function () {
    ...
    new function () {
        ...
        if (jQuery.browser.mozilla || jQuery.browser.opera) document.addEventListener("DOMContentLoaded", jQuery.ready, false); else if (jQuery.browser.msie) {
    ...
    if (jQuery.browser.msie) jQuery(window).one("unload", function () {
        ...
        for (var b in a) {
            ...
            if (i && b != 'unload') do c[i - 1] && jQuery.event.remove(c[i - 1], b); while (--i)
        }
    });
    jQuery.fn.extend({
        loadIfModified: function (a, b, c) {
            ...
            if (jQuery.isFunction(c)) return this.bind("load", c);
            e = e || function () {
            };
            var g = "GET";
            ...
            jQuery.ajax({
                url: c, type: g, data: d, ifModified: f, complete: function (a, b) {
                    if (b == "success" || !f && b == "notmodified") h.attr("innerHTML", a.responseText).evalScripts().each(e, [a.responseText, b, a]); else e.apply(h, [a.responseText, b, a])
                }
            });
            return this
        }, serialize: function () {
            ...
            return this.find("script").each(function () {
                if (this.src) jQuery.getScript(this.src); else jQuery.globalEval(this.text || this.textContent || this.innerHTML || "")
            }).end()
        }
    });
    ...
    jQuery.extend({
        get: function (a, b, c, d, e) {
            ...
            return jQuery.ajax({type: "GET", url: a, data: b, success: c, dataType: d, ifModified: e})
        },
        ...
        post: function (a, b, c, d) {
            ...
            return jQuery.ajax({type: "POST", url: a, data: b, success: c, dataType: d})
        },
        ...
        ajax: function (s) {
            ...
            if (s.data) g.setRequestHeader("Content-Type", s.contentType);
            if (s.ifModified) g.setRequestHeader("If-Modified-Since", jQuery.lastModified[s.url] || "Thu, 01 Jan 1970 00:00:00 GMT");
            g.setRequestHeader("X-Requested-With", "XMLHttpRequest");
            if (s.beforeSend) s.beforeSend(g);
            if (s.global) jQuery.event.trigger("ajaxSend", [g, s]);
            var h = function (a) {
                if (g && (g.readyState == 4 || a == "timeout")) {
                    ...
                    try {
                        ...
                        if (b != "error") {
                            ...
                            if (s.ifModified && c) jQuery.lastModified[s.url] = c;
                            var d = jQuery.httpData(g, s.dataType);
                            if (s.success) s.success(d, b);
                            if (s.global) jQuery.event.trigger("ajaxSuccess", [g, s])
                        } else jQuery.handleError(s, g, b)
                    } catch (e) {
                        b = "error";
                        jQuery.handleError(s, g, b, e)
                    }
                    if (s.global) jQuery.event.trigger("ajaxComplete", [g, s]);
                    if (s.global && !--jQuery.active) jQuery.event.trigger("ajaxStop");
                    if (s.complete) s.complete(g, b);
                    if (s.async) g = null
                }
            };
        ...
        httpData: function (r, a) {
            ...
            if (a == "script") jQuery.globalEval(c);
            if (a == "json") c = (" + c + ");
            if (a == "html") jQuery("<div>").html(c).evalScripts();
            return c
        },
        param: function (a) {
            var s = [];
        ...
        globalEval: function (a) {
            if (window.execScript) window.execScript(a); else if (jQuery.browser.safari) window.setTimeout(a, 0); else eval.call(window, a)
        }
    });
    jQuery.fn.extend({
        show: function (a, b) {
        ...
        }, _toggle: jQuery.fn.toggle, toggle: function (a, b) {
            ...
            return this.queue(function () {
                ...
                jQuery.each(d, function (a, b) {
                    ...
                    if (b.constructor == Number) e.custom(e.cur(), b); else e[b == "toggle" ? c ? "show" : "hide" : b](d)
                })
            })
        }, queue: function (a, b) {
            if (!b) {
    ...
    jQuery.extend({
        speed: function (a, b, c) {
            ...
            var y = e.style;
            z.a = function () {
                if (f.step) f.step.apply(e, [z.now]);
                if (g == "opacity") jQuery.attr(y, "opacity", z.now); else {
            ...
            z.step = function (a, b) {
                ...
                if (t > f.duration + z.startTime) {
                    z.now = b;
                    z.a();
                    if (e.curAnim) e.curAnim[g] = true;
                    var c = true;
                    for (var i in e.curAnim) if (e.curAnim[i] !== true) c = false;
                    if (c) {
                        if (f.display != null) {
                            y.overflow = f.overflow;
                            y.display = f.display;
                            if (jQuery.css(e, "display") == "none") y.display = "block"
                        }
                        if (f.hide) y.display = "none";
                        if (f.hide || f.show) for (var p in e.curAnim) jQuery.attr(y, p, e.orig[p])
                    }
                    if (c && jQuery.isFunction(f.complete)) f.complete.apply(e);
                    return false
                } else {
